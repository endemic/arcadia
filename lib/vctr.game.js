...
Vctr.Game = function (width, height, layers) {
	...
	Vctr.constants.width = width;
	Vctr.constants.height = height;

	// Create the #Vctr container, give it a size, etc.

	this.element = document.createElement('div');
	this.element.setAttribute('id', Vctr.constants.id);
...
Vctr.Game.prototype.onPointStart = function (event) {
	var i = 0,
		length,
		points = [];
...
Vctr.Game.prototype.onPointMove = function (event) {
	var i = 0,
		length,
		points = [];
...
Vctr.Game.prototype.onPointEnd = function (event) {
	var i = 0,
		length,
		points = [];
...
Vctr.Game.prototype.onKeyDown = function (event) {
	var input = {},
		key;
...
Vctr.Game.prototype.onKeyUp = function (event) {
	var input = {},
			key;
...
Vctr.Game.prototype.start = function () {
	var previousDelta,
		self,
		tick;
...
Vctr.Game.prototype.stop = function () {
	window.cancelAnimationFrame(this.updateId);
};

Vctr.Game.prototype.update = function (context, dt) {
